...
class AlignerDistanceMapPointPoint_
    : public Aligner_<VariableSE2DistanceMapRightType_>
{
 public:
  ...
  using ThisType =
      AlignerDistanceMapPointPoint_<VariableSE2DistanceMapRightType_>;
 ...
 public:
  ...
  {
    assert(source &&
           "AlignerDistanceMapPointPoint_::setSource | source point cloud not "
           "set");
  ...
  {
    assert(source &&
           "AlignerDistanceMapPointPoint_::setSource | source SE2 variable not "
           "set");
    assert(source->measurement() &&
           "AlignerDistanceMapPointPoint_::setSource | source measurement not "
           "set");
    assert(source->measurement()->getPointCloudPtr() &&
           "AlignerDistanceMapPointPoint_::setSource | source point cloud "
           "shared ptr not set");
  ...
  {
    assert(target &&
           "AlignerDistanceMapPointPoint_::setTarget | target point cloud not "
           "set");
  ...
  {
    assert(target &&
           "AlignerDistanceMapPointPoint_::setTarget | target SE2 variable not "
           "set");
    assert(target->measurement() &&
           "AlignerDistanceMapPointPoint_::setTarget | target measurement not "
           "set");
    assert(target->measurement()->getPointCloudPtr() &&
           "AlignerDistanceMapPointPoint_::setTarget | target point cloud "
           "shared ptr not set");
...
};  // class AlignerDistanceMapPointPoint_<VariableSE2DistanceMapRightType_> :
