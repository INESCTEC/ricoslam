...
using PointBaseExampleType = PointBase_<3, PointFieldCoordinates_<float, 3>,
                                        PointFieldDirection_<float, 3>>;

using PointBaseTransformExampleType =
    PointBase_<2, PointFieldCoordinates_<float, 2>,
               PointFieldDirection_<float, 2>>;

TEST(pcl_point_base, constructor)
{
...
TEST(pcl_point_base, transformInPlace)
{
  constexpr float x = 5.f;
  constexpr float y = 3.f;
...
TEST(pcl_point_base, euclideanToPolar)
{
...
TEST(pcl_point_base, polarToEuclidean)
{
