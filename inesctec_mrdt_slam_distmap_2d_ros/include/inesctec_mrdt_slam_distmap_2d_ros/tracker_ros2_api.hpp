...
class TrackerROS2API : public rclcpp::Node
{
 public:

  using ThisType = TrackerROS2API;
 ...
 public:
  ...
  explicit TrackerROS2API(
      const std::string& name = "tracker_ros2_api",
      const rclcpp::NodeOptions& options = rclcpp::NodeOptions());
  virtual ~TrackerROS2API() = default;
