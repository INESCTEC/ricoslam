...
class TrackerROS1Offline : public TrackerROS1API
{
 public:

  using ThisType = TrackerROS1Offline;
 ...
 public:
  ...
  TrackerROS1Offline(const ParamOffline& param);
  virtual ~TrackerROS1Offline();
