...
using OGLViewerType = inesctec_mrdt_slam_distmap_2d_ros::TrackerROS1Offline::
    TrackerType::OGLViewerType;

int main(int argc, char* argv[])
{
  ros::init(argc, argv, "tracker_offline", ros::init_options::NoSigintHandler);

  inesctec_mrdt_slam_distmap_2d_ros::TrackerROS1Offline::ParamOffline param;

  boost::program_options::options_description opts_desc(
      "Usage: rosrun inesctec_mrdt_slam_distmap_2d_ros tracker_offline "
  ...
  try
  {
    inesctec_mrdt_slam_distmap_2d_ros::TrackerROS1Offline tracker(param);
