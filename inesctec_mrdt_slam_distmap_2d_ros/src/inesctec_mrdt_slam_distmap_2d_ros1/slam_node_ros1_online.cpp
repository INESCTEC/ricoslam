...
using OGLViewerType =
    inesctec_mrdt_slam_distmap_2d_ros::SLAMROS1Online::SLAMType::OGLViewerType;

int main(int argc, char* argv[])
{
  ros::init(argc, argv, "slam_online");

  try
  {
    inesctec_mrdt_slam_distmap_2d_ros::SLAMROS1Online slam;
