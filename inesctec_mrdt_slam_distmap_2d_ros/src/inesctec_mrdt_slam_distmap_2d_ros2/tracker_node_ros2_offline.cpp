...
using OGLViewerType = inesctec_mrdt_slam_distmap_2d_ros::TrackerROS2Offline::
    TrackerType::OGLViewerType;
...
int main(int argc, char* argv[])
{
  ...
  inesctec_mrdt_slam_distmap_2d_ros::TrackerROS2Offline::ParamOffline param;

  boost::program_options::options_description opts_desc(
      "Usage: ros2 run inesctec_mrdt_slam_distmap_2d_ros tracker_offline "
  ...
  {
    OFFLFATAL(
        "[tracker_node_ros2_offline] something went wrong.... (error: %s)\n",
  ...
  {
    OFFLFATAL("[tracker_node_ros2_offline] unexpected behavior.....\n");
    std::cout << opts_desc << std::endl;
    return -1;
  }
  ...
  try
  {
    ...
    inesctec_mrdt_slam_distmap_2d_ros::TrackerROS2Offline tracker(
        param, "tracker_offline", opts);
  ...
  {
    OFFLFATAL("[tracker_node_ros2_offline] Fatal error: %s", e.what());
